...
const WhatsAppFAB = () => {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      TRIGGER_POINTS.filter(t => t.type === "scroll").forEach(t => {
        if (progress >= t.threshold && !triggeredScrollPoints.current.has(t.threshold)) {
          triggeredScrollPoints.current.add(t.threshold);
          setShowTooltip(true);
        }
      });
    };
    ...
    <div className="fixed bottom-6 right-6 z-50 flex items-end gap-3">
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: "0 8px 32px rgba(0,0,0,0.5), 0 0 20px rgba(196,154,60,0.08)",
              }}
            >
              <button
            ...
            <div
              ...
              style={{
                backgroundColor: "#18161E",
                borderRight: "1px solid rgba(196,154,60,0.25)",
      ...
      >
        ...
        <div
          ...
          style={{ animation: "whatsapp-pulse 2s ease-out infinite 1s" }}
        />
      </motion.a>
    </div>
  );
